...
from net.Mynet import BIPCENet
...
if __name__ == '__main__':
    ...
    if ep.lol:
        ...
        if ep.perc:
            weight_path = './weights/LOLv1/epoch_1230.pth'
        else:
            weight_path = './weights/LOLv1/epoch_1230.pth'
        ...
        if ep.best_GT_mean:
            weight_path = './weights/LOLv2_real/epoch_1300.pth'
            alpha = 0.84
        elif ep.best_PSNR:
            weight_path = './weights/LOLv2_real/epoch_560.pth'
            alpha = 0.80
        elif ep.best_SSIM:
            weight_path = './weights/LOLv2_real/epoch_560.pth'
            alpha = 0.82
